                    ...
                    <div class="content">
                        <div class="module">
                            ...
                            <div class="module-option clearfix">
                                ...
                                <!-- <a href="{{url('/create/'.$user->id)}}"><button type="button"  style="margin-left:48%"class="btn btn-primary"><i class="icon-menu icon-plus"><b style="color:white">Add Product</b></i></button>
                                </a>
                                -->
                            </div>
                                    ...
                                    <div class="span6">
                                        <div class="media user">
                                            <a class="media-avatar pull-left" href="#">
                                                <img src="{{ URL::asset('img/product-img/'.$products->Image) }}">
                                            </a>
                                            <div class="media-body">
                                                ...
                                                <p>
                                                    <small class="muted">{{$products->Prix}} DT</small></p>
                                                <div class="media-option btn-group shaded-icon">
                                                    <a href="{{url('/upProd/'.$products->Id_prod)}}"><button class="btn btn-small">
                                                        <i class="icon-edit"></i>
                                                    </button></a>
                                                    <form action="{{url('/user/'.$products->Id_prod)}}" method="POST">
