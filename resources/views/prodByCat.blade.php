                    ...
                    <div class="col-12 col-sm-6 col-md-12 col-xl-6">
                        <div class="single-product-wrapper">
                            ...
                            <div class="product-img">
                                ...
                                <img src="{{ URL::asset('img/product-img/'.$prod->Image) }}" alt=""> 
                            </div>
                            ...
                            <div class="product-description d-flex align-items-center justify-content-between">
                                ...
                                <div class="product-meta-data">
                                    ...
                                    <a href="{{ url('/product/'.$prod->Id_prod) }}">
                                         <h6 style="text-decoration:none; font-weight:500; color:black;">{{$prod->Name}}</h6>
                                    </a>
                                </div>
                                <!-- Ratings & Cart -->
                                <div class="ratings-cart text-right">
                                    ...
                                    <div class="cart">
                                        <a href="cart.html" data-toggle="tooltip" data-placement="left" title="Add to Cart"><img src="{{asset('img/core-img/cart.png')}}" alt=""></a>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="container">
            ...
            Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved.
                ...
                <div class="col-12 col-lg-8" >
                    <div class="single_widget_area" >
                        <!-- Footer Menu -->
                        <div class="footer_menu" style="margin-left:245px;">
