                    ...
                    <div class="content">
                        <div class="module">
                            ...
                            <div class="module-option clearfix">
                                ...
                                <a href="{{url('/create')}}"><button type="button"  style="margin-left:48%"class="btn btn-primary"><i class="icon-menu icon-plus"><b style="color:white">Add Product</b></i></button>
                                </a>
